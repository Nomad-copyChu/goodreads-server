...
var isAdmin = graphql_shield_1.rule()(function (parent, args, ctx, info) { return __awaiter(void 0, void 0, void 0, function () {
...
var isLoggedIn = graphql_shield_1.rule()(function (parent, args, ctx, info) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (ctx.user) {
            return [2 /*return*/, true];
        }
...
var permissions = graphql_shield_1.shield({
    Query: {
