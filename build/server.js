    ...
    context: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    id = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET);
                    return [4 /*yield*/, prisma_client_1.prisma.user({ id: id })];
                case 2:
                    user = _a.sent();
                    if (user) {
                        if (user.isAdmin) {
                            return [2 /*return*/, __assign(__assign({}, context), { user: user, isAdmin: true })];
                        }
