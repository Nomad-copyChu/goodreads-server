...
exports.default = {
    Mutation: {
        subFromShelf: function (_, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var user, shelfName, bookId, display, shelves, book;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_client_1.prisma.user({ id: user.id }).displays({
                    ...
                    case 3:
                        book = _a.sent();
                        bookCount_1.subBookCount(book, shelfName);
                        return [4 /*yield*/, prisma_client_1.prisma.deleteDisplay({ id: shelves[0].id })];
