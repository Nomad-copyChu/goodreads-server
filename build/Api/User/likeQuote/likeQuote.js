...
exports.default = {
    Mutation: {
        likeQuote: function (_, args, _a) {
            var user = _a.user;
            return __awaiter(void 0, void 0, void 0, function () {
                var quoteId, existLike, prevLikesCount;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            _b.sent();
                            return [4 /*yield*/, prisma_client_1.prisma.quote({ id: quoteId }).likesCount()];
                        case 3:
                            prevLikesCount = _b.sent();
